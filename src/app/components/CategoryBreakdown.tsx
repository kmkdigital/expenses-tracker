                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ marginTop: 6 }}>
                          {sub.transactions.map(t => (
                            <div key={t.id} style={{ display: 'flex', alignItems: 'flex-start', padding: '3px 0', fontSize: 12, color: 'var(--text-3)', gap: 8 }}>
                              <div style={{ width: 5, height: 5, borderRadius: '50%', background: cat.color, flexShrink: 0, marginTop: 5, opacity: 0.7 }} />
                              <span style={{ wordBreak: 'break-word', flex: 1 }}>{t.description}</span>
