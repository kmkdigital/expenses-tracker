...
export const CATEGORY_RULES: CategoryRule[] = [
  ...
  { category: 'Food & Dining', subcategory: 'Groceries', keywords: ['grocery', 'groceries', 'supermarket', 'walmart', 'costco', 'aldi', 'lidl', 'whole foods', 'trader joe', 'kroger', 'safeway', 'publix', 'market', 'food store', 'fresh market'] },
  ...
  { category: 'Housing', subcategory: 'Utilities', keywords: ['electric', 'electricity', 'gas bill', 'water bill', 'utility', 'utilities', 'power', 'energy', 'sewage'] },
  { category: 'Housing', subcategory: 'Internet & Phone', keywords: ['internet', 'broadband', 'wifi', 'at&t', 'verizon', 'comcast', 'xfinity', 't-mobile', 'sprint', 'phone bill', 'mobile plan', 'telecom'] },
  ...
  // TRANSPORT
  { category: 'Transport', subcategory: 'Fuel', keywords: ['fuel', 'gas station', 'petrol', 'shell', 'bp', 'exxon', 'chevron', 'mobil', 'sunoco', 'texaco', 'circle k', 'speedway'] },
  { category: 'Transport', subcategory: 'Ride Share', keywords: ['uber', 'lyft', 'taxi', 'cab', 'ride share', 'rideshare', 'bolt', 'grab'] },
  { category: 'Transport', subcategory: 'Public Transit', keywords: ['metro', 'subway', 'bus pass', 'transit', 'mta', 'train ticket', 'rail', 'oyster', 'commute'] },
  ...
  // ENTERTAINMENT
  { category: 'Entertainment', subcategory: 'Streaming', keywords: ['netflix', 'hulu', 'disney+', 'amazon prime', 'hbo', 'apple tv', 'spotify', 'youtube premium', 'paramount', 'peacock', 'streaming'] },
  ...
  { category: 'Entertainment', subcategory: 'Bars & Nightlife', keywords: ['bar', 'pub', 'nightclub', 'club', 'lounge', 'brewery', 'winery', 'liquor', 'alcohol'] },
  ...
  { category: 'Shopping', subcategory: 'Electronics', keywords: ['apple', 'best buy', 'amazon', 'electronics', 'laptop', 'phone', 'tablet', 'gadget', 'tech', 'newegg'] },
